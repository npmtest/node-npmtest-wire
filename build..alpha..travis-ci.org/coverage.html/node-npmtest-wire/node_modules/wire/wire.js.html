...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wire/node_modules/wire/wire.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wire/node_modules/wire/wire.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wire/node_modules/wire/</a> &#187; wire.js</div>
</div>
<div class="body">
...
&nbsp;
	 ...
	 */
<span class="fstat-no" title="function not covered" >	function wire(spec, options) {</span>
&nbsp;
		// If the root context is not yet wired, wire it first
<span class="cstat-no" title="statement not covered" >		if (!rootContext) {</span>
<span class="cstat-no" title="statement not covered" >			rootContext = createContext(rootSpec, null, rootOptions);</span>
		}
&nbsp;
		// Use the rootContext to wire all new contexts.
<span class="cstat-no" title="statement not covered" >		return rootContext.then(<span class="fstat-no" title="function not covered" >function (root) {</span></span>
<span class="cstat-no" title="statement not covered" >			return root.wire(spec, options);</span>
		});
	}
&nbsp;
	/**
	 ...
	 */
	wire.load = <span class="fstat-no" title="function not covered" >function amdLoad(name, require, done /*, config */) {</span>
		// If it's a string, try to split on ',' since it could be a comma-separated
		// list of spec module ids
<span class="cstat-no" title="statement not covered" >		wire(name.split(','), { require: require })</span>
			.then(done, done.error)
			.otherwise(crash);
&nbsp;
<span class="fstat-no" title="function not covered" >		function crash(e) {</span>
...
<span class="cstat-no" title="statement not covered" >			setTimeout(<span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >throw e; </span>}, 0);</span>
		}
	};
&nbsp;
	/**
